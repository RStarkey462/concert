                  ...
                  <nav id="primary-navigation" class="site-navigation">
                      <div id="main-menu" class="main-nav main-menu">
                          <ul class="menu-nav">
                              ...
                              <li class="menu-item"><a href= "my-account.php">My Account</a></li>
              ...
              <div class="container">
                  <div class="row">
                      <div class="col-sm-4 wow zoomIn" data-wow-delay="0.6s">
                          <div class="sevice-box-wrap sevice-style_4">
                              <div class="sevice-box-content">
                                  <h5 class="sevice-title"><a href="previous.html">Previous events</a></h5>
                                  <p class="sevice-desc">
                                  </p>
                              </div>
                      ...
                      <div class="col-sm-4 wow zoomIn" data-wow-delay="0.6s">
                          <div class="sevice-box-wrap sevice-style_4">
                              <div class="sevice-box-content">
                                  <h5 class="sevice-title"><a href="july.html">This months events</a></h5>
                                  <p class="sevice-desc">
                                  </p>
                              </div>
                      ...
                      <div class="col-sm-4 wow zoomIn" data-wow-delay="0.6s">
                          <div class="sevice-box-wrap sevice-style_4">
                              <div class="sevice-box-content">
                                  <h5 class="sevice-title"><a href="#">August events</a></h5>
                                  <p class="sevice-desc">
                                  </p>
                              </div>
